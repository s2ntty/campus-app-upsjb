    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            if (!authService.isConfigured || !authService.isConfigured()) {
                alert('Google OAuth no está configurado aún. Usa el login manual por ahora.');
                return;
            }
            ...
            if (error.message?.includes('Invalid login credentials') || error.message?.includes('Provider not enabled')) {
                alert('Google OAuth no está habilitado en Supabase. Usa el login manual por ahora.');
            } else {
                alert('Error al iniciar sesión con Google. Inténtalo de nuevo o usa el login manual.');
            }
        } finally {

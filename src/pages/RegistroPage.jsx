...
const RegistroPage = ({ onRegister, onShowLogin, user, onLogout }) => {
    ...
    const completeRegistration = async () => {
        console.log('🚀 Iniciando completeRegistration...');
        setLoading(true);
        ...
        try {
            ...
            const userData = {
                ...
                carrera: `${selectedCarrera?.nombre} • Sede ${formData.sede}`,
            ...
            // Si hay usuario de Firebase (Google), guardar en Supabase
            if (user) {
                ...
                const supabaseData = {
                    ...
                    sede: userData.sede,
                    anioIngreso: userData.anioIngreso,
                ...
                if (userData.telefono) {
                    supabaseData.telefono = userData.telefono;
                }
                if (userData.fechaNacimiento) {
                    supabaseData.fechaNacimiento = userData.fechaNacimiento;
                }

                await userService.createOrUpdateProfile(user, supabaseData);

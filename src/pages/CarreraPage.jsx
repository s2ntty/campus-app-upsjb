...
// import { materiasService } from '../lib/supabase'; // Descomenta cuando tengas Supabase configurado
...
const CarreraPage = ({ carrera }) => {
    ...
    // TODO: Función para cargar desde Supabase
    // const loadMateriasFromSupabase = async () => {
    //     try {
    //         const userId = 'user-id'; // Obtener del contexto de autenticación
    //         const materias = await materiasService.getMaterias(userId);
    //         const estadoMap = {};
    ...
    // TODO: Función para guardar en Supabase
    // const saveToSupabase = async (materiaId, status, nota, modalidad) => {
    //     try {
    //         const userId = 'user-id'; // Obtener del contexto de autenticación
    //         await materiasService.updateMateriaStatus(userId, materiaId, status, nota, modalidad);
    //     } catch (error) {
